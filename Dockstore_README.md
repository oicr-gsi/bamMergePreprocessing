# dockstore_bamMergePreprocessing
...
cp /pipeline/recipes/bam-merge-preprocessing_data_modules_prep.yaml code/gsi/data_modules_recipe_prep.yaml
...
cp /pipeline/recipes/bam-merge-preprocessing_data_modules.yaml data/gsi/data_modules_recipe.yaml

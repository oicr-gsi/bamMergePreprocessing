...
`filterBam.modules`|String|"samtools/1.9 gatk/4.1.6.0 python/2.7"|Environment module name and version to load (space separated) before command execution.
...
`mergeMultipleBam.modules`|String|"gatk/4.1.6.0 python/2.7"|Environment module name and version to load (space separated) before command execution.
...
`mergeBams.modules`|String|"gatk/4.1.6.0 python/2.7"|Environment module name and version to load (space separated) before command execution.
